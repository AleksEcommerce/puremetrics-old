...
// update variant name in pdp
document.querySelectorAll('.variant__button-label').forEach(btn => {
  let currentBtn = btn;
  btn.addEventListener('click', () => {
    currentBtn.closest('.variant-wrapper').querySelector('.variant__label .variant_value').innerHTML = currentBtn.closest('.variant-input').getAttribute('data-value');
  })
})
